...
module.exports = {
  command: 'ارحب1',
  description: 'يرحب بعضو باستخدام منشن أو رقم مع لقبه + صوت',
  category: 'group',
  usage: '.ارحب1 @العضو أو رقمه لقبه',
  group: true,
    ...
    try {
      ...
      if (!Array.isArray(args) || args.length < 2) {
        return await sock.sendMessage(msg.key.remoteJid, {
          text: '❗ الاستخدام: .ارحب1 @العضو أو رقمه لقبه\nمثال: .ارحب1 @123456789 زورو أو .ارحب1 4567890 زورو',
        }, { quoted: msg });
      }
