...
module.exports = {
  command: "ايتاتشي",
  category: "edit",
  description: "عرض ايديت ايتاتشي أوتشيها",
  usage: ".ايديتشي",

  async execute(sock, msg) {
    const chatId = msg.key.remoteJid;
    const tiktokUrl = "https://vt.tiktok.com/ZSBQjeKNw/";
    ...
    try {
      ...
      console.error("❌ خطأ في تنفيذ أمر ايتاتشي:", err);
      await sock.sendMessage(chatId, {
