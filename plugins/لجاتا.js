...
module.exports = {
  command: ['لجاتا'],
  description: 'تحويل صوره الشخص لصوره شخص ف عالم جاتا 🐊',
  category: 'ai',
    ...
    try {
      ...
      if (!quoted || !quoted.imageMessage) {
        return sock.sendMessage(msg.key.remoteJid, {
          text: '❌ الصورة الي هتحولها لجاتا فين يا نجم؟ 🐊',
        }, { quoted: msg });
      }

      await sock.sendMessage(msg.key.remoteJid, { text: '⏳ جاري تحويل الصورة لجاتا...' }, { quoted: msg });
      ...
      // برومبت تحويل لأنمي
      const prompt =
"Transform this image into GTA 5 loading screen style with cartoonish shading, bold outlines, and urban background.";
      ...
      await sock.sendMessage(
        msg.key.remoteJid,
        { image: { url: resultUrl }, caption: '🎮 GTA vibes 🔫✨' },
        { quoted: msg }
      );
    } catch (e) {
