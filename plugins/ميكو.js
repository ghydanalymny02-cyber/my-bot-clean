...
const gameSettings = {
  ...
  dataFile: path.join(__dirname, '..', 'data', 'miku.json') // هنا ملف فكك.json
};
...
module.exports = {
  command: ['ميكو'],
  description: 'اعرف اسم الفيلم/المسلسل من الايموجي 🥀',
  category: 'ترفيه',
