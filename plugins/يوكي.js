...
module.exports = {
  command: ['يوكي'],
  description: '⚙️ يعرض معلومات البوت باسم يوكي',
  category: 'tools',
...
✨ « يوكي… اسم يضيف للبوت برودة الثلج وهيبة الشتاء. »
`.trim();
      ...
      console.error('❌ خطأ في أمر يوكي:', err);
      await sock.sendMessage(msg.key.remoteJid, {
        text: '❌ حصل خطأ أثناء عرض معلومات يوكي.'
      }, { quoted: msg });
    }
  }
};