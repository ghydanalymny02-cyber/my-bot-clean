...
module.exports = {
  command: "زورو",
  description: "ايديت انمي لرورونوا زورو",
  category: "edit",
  usage: ".زورو",

  async execute(sock, msg) {
    const chatId = msg.key.remoteJid;
    const tiktokUrl = "https://vt.tiktok.com/ZSBQ2RfE9/";
    ...
    try {
      await sock.sendMessage(chatId, {
        text: `📤 جاري إرسال الايديت الخاص بـ *رورونوا زورو*...`
      }, { quoted: msg });
      ...
      exec(`yt-dlp -f best -o "${videoPath}" "${tiktokUrl}"`, async (errDownload) => {
        ...
        await sock.sendMessage(chatId, {
          video: { url: videoPath },
          caption: `🎬 ايديت خاص بـ *رورونوا زورو* ⚔️`
        }, { quoted: msg });
      ...
      console.error("❌ خطأ في تنفيذ أمر زورو:", err);
      await sock.sendMessage(chatId, {
