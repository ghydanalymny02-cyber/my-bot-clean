...
module.exports = {
  command: ['الوعي'],
  description: 'ترفيه: لعبة اسئلة وعي 🤯',
  category: 'ترفيه',
  usage: '.الوعي',
  group: true,
 ...
 "اكتر مسلسل - فيلم حبيته فحياتك ؟", 
 
 "اكتر  كرتون حبيته فحياتك ؟", 
    ];
    ...
    // صورة الوعي
    const imagePath = path.join(__dirname, '../resources/الوعي.jpg');
...
*⊱⪨༻𓆩〘✨ تم تشغيل امر الــوعــي يا قلبي ✨〙𓆪༺⪩⊰*
`;
