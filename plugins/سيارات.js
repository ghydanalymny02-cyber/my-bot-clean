...
module.exports = {
  command: 'سيارات',
  description: 'يبعت فيديو سيارات عشوائي + ردة فعل 🚘 لأي حد',
  category: 'edit',
  ...
  async execute(sock, msg) {
    try {
      ...
      await sock.sendMessage(chatJid, {
        text: `🚘 فيديو سيارات عشوائي قادم، استعد!`,
      });
      ...
      const videoMsg = await sock.sendMessage(chatJid, {
        ...
        caption: '🥳 استمتع بمشاهدة السيارات!',
      }, { quoted: msg });
      ...
      console.error('خطأ في أمر سيارات:', err);
