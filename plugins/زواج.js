module.exports = {
  ...
  async execute(sock, msg, args = []) {
    try {
      ...
      const names = [
        '🥰 مبروك يا عرسان! بواسطة عمكم مــجــهــول||𝕲𝕳𝕰𝕯𝕬𝕹',
        '💞 تم عقد القِران! بواسطة عمكم مــجــهــول||𝕲𝕳𝕰𝕯𝕬𝕹',
        '❤️‍🔥 الله يتمم بخير! بواسطة عمكم مــجــهــول||𝕲𝕳𝕰𝕯𝕬𝕹',
        '👰‍♀️🤵‍♂️ زواج السنة! بواسطة عمكم مــجــهــول||𝕲𝕳𝕰𝕯𝕬𝕹',
        '🔔 دق الجرس... الف مبروك! بواسطة عمكم مــجــهــول||𝕲𝕳𝕰𝕯𝕬𝕹'
      ];
