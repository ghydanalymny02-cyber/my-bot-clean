module.exports = {
  command: 'ياباني',
  desc: 'ترحيب بالياباني',
  usage: '.ياباني @العضو أو رقمه لقبه',
  group: true,
    ...
    try {
      ...
      if (!Array.isArray(args) || args.length < 2) {
        return await sock.sendMessage(msg.key.remoteJid, {
          text: '❗ الاستخدام: .ياباني @العضو أو رقمه لقبه\nمثال: .ياباني @123456789 زورو أو .ياباني 201234567890 زورو',
        }, { quoted: msg });
      }
      ...
      const caption = `𝑱𝑨𝑷𝑨𝑵 ON TOP 🫦🇯🇵
      —————
   نورت  اليابان  يا  @${targetJid.split('@')[0]} 🇯🇵
  من الان انت ضمن منظمة اليابان 🫦
     في منظمة اليابان : 🇯🇵
     ① ننشر اهم الزرفات 💰
     ② توثيق الباند 📟
     ③ نوزع ارقام 🪀
     ...
     —————`.trim();
      ...
      const messageData = {
        ...
        contextInfo: {
          ...
          externalAdReply: {
            title: `${nickname} أنت الان ياباني 🇯🇵`,
