...
module.exports = {
  command: "يوجي",
  description: "ايديت انمي لشخصية يوجي إيتادوري",
  category: "edit",
  usage: ".يوجي",

  async execute(sock, msg) {
    const chatId = msg.key.remoteJid;
    const tiktokUrl = "https://vt.tiktok.com/ZSBQ2JAeg/";
    ...
    try {
      await sock.sendMessage(chatId, {
        text: `📤 جاري إرسال الايديت الخاص بـ *يوجي إيتادوري*...`
      }, { quoted: msg });
      ...
      exec(`yt-dlp -f best -o "${videoPath}" "${tiktokUrl}"`, async (errDownload) => {
        ...
        await sock.sendMessage(chatId, {
          video: { url: videoPath },
          caption: `🎬 ايديت خاص بـ *يوجي إيتادوري* 🔥`
        }, { quoted: msg });
      ...
      console.error("❌ خطأ في تنفيذ أمر يوجي:", err);
      await sock.sendMessage(chatId, {
