...
module.exports = {
  command: ['أيرين'],
  description: '⚙️ يعرض معلومات البوت باسم أيرين',
  category: 'tools',
...
✨ « أيرين… اسم يضيف للبوت قوة المقاتل وعزيمة لا تنكسر. »
`.trim();
      ...
      console.error('❌ خطأ في أمر أيرين:', err);
      await sock.sendMessage(msg.key.remoteJid, {
        text: '❌ حصل خطأ أثناء عرض معلومات أيرين.'
      }, { quoted: msg });
    }
  }
};