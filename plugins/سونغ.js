...
module.exports = {
  command: "سونغ",
  category: "edit",
  description: "ايديت أنمي سونغ جينوو من Solo Leveling",
  usage: ".سونغ",

  async execute(sock, msg) {
    const chatId = msg.key.remoteJid;
    const tiktokUrl = "https://vt.tiktok.com/ZSBQYCP7b/";
    ...
    try {
      ...
      exec(`yt-dlp -f best -o "${videoPath}" "${tiktokUrl}"`, async (errDownload) => {
        ...
        await sock.sendMessage(chatId, {
          video: { url: videoPath },
          caption: `🎬 *ايديت: سونغ جينوو*\nمن أنمي Solo Leveling`
        }, { quoted: msg });
      ...
      console.error("❌ خطأ في تنفيذ أمر سونغ:", err);
      await sock.sendMessage(chatId, {
