...
module.exports = {
  command: "كينتو",
  description: "عرض ايديت كينتو نانامي",
  category: "edit",
  usage: ".ايديت كينتو",

  async execute(sock, msg) {
    const chatId = msg.key.remoteJid;
    const tiktokUrl = "https://vt.tiktok.com/ZSBQju3eS/";
    ...
    try {
      ...
      console.error("❌ خطأ في تنفيذ أمر كينتو نانامي:", err);
      await sock.sendMessage(chatId, {
