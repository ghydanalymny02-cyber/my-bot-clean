...
module.exports = {
  ...
  command: ["نظام"],
  category: "fun",
  description: "مــجــهــول||𝕲𝕳𝕰𝕯𝕬𝕹⊰𝑩𝑶𝑻 🌋  - تجربة سايبربانك تحليلية تفاعلية 🚀",

  async execute(sock, msg, args = []) {
    const jid = msg.key.remoteJid;
    const footer = "مــجــهــول||𝕲𝕳𝕰𝕯𝕬𝕹⊰𝑩𝑶𝑻 🌋";
    ...
    try {
      // رسالة تمهيدية
      await sock.sendMessage(jid, { text: `☀️ جاري تشغيل مــجــهــول||𝕲𝕳𝕰𝕯𝕬𝕹⊰𝑩𝑶𝑻 🌋 على ${name}...` }, { quoted: msg });
