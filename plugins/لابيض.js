    ...
    try {
      ...
      if (!quoted || !quoted.imageMessage) {
        return sock.sendMessage(msg.key.remoteJid, {
          text: '❌ الصورة الي هبيضها فين يا معلم؟ 🐦‍⬛',
        }, { quoted: msg });
      }

      await sock.sendMessage(msg.key.remoteJid, { text: '⏳ يتم التبييض...' }, { quoted: msg });
      ...
      // برومبت افتراضي
      const prompt =
        "Change only the skin color to light/white while keeping all other elements exactly the same including facial features, lighting, hair, clothing, pose, background, and style. Make skin tone look natural, smooth, and realistic with proper texture.";
      ...
      await sock.sendMessage(
        msg.key.remoteJid,
        { image: { url: resultUrl }, caption: '✅ تم التبيض 🧑🏻👍🏻' },
        { quoted: msg }
      );
    } catch (e) {
      console.error('🚫 خطأ في أمر لابيض:', e);
      await sock.sendMessage(
        msg.key.remoteJid,
