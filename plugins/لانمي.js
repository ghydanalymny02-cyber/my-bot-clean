    ...
    try {
      ...
      if (!quoted || !quoted.imageMessage) {
        return sock.sendMessage(msg.key.remoteJid, {
          text: '❌ الصورة الي هتحولها لأنمي فين يا نجم؟ 🎌',
        }, { quoted: msg });
      }

      await sock.sendMessage(msg.key.remoteJid, { text: '⏳ جاري تحويل الصورة لأنمي...' }, { quoted: msg });
      ...
      // برومبت تحويل لأنمي
      const prompt =
        "Convert this image into high-quality anime style while preserving identity, clothing, pose, and background. Make it look like authentic anime art with clean lines, shading, and vibrant colors.";
      ...
      await sock.sendMessage(
        msg.key.remoteJid,
        { image: { url: resultUrl }, caption: '✅ تم التحويل لأنمي 🎌✨' },
        { quoted: msg }
      );
    } catch (e) {
