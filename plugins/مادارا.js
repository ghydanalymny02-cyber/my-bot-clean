...
module.exports = {
  command: "مادارا",
  description: "عرض ايديت مادارا أوتشيها",
  category: "edit",
  usage: ".ايديت مادارا",

  async execute(sock, msg) {
    const chatId = msg.key.remoteJid;
    const tiktokUrl = "https://vt.tiktok.com/ZSBQ2bPxJ/";
    ...
    try {
      ...
      console.error("❌ خطأ في تنفيذ أمر مادارا:", err);
      await sock.sendMessage(chatId, {
