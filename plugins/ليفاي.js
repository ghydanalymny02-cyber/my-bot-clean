...
module.exports = {
  command: "ليفاي",
  category: "edit",
  description: "ايديت انمي لشخصية ليفاي أكرمان",
  usage: ".ليفاي",

  async execute(sock, msg) {
    const chatId = msg.key.remoteJid;
    const tiktokUrl = "https://vt.tiktok.com/ZSBQ2rxQW/";
    ...
    try {
      await sock.sendMessage(chatId, {
        text: `📤 جاري إرسال الايديت الخاص بـ *ليفاي أكرمان*...`
      }, { quoted: msg });
      ...
      exec(`yt-dlp -f best -o "${videoPath}" "${tiktokUrl}"`, async (errDownload) => {
        ...
        await sock.sendMessage(chatId, {
          video: { url: videoPath },
          caption: `🎬 ايديت خاص بـ *ليفاي أكرمان* ⚔️`
        }, { quoted: msg });
      ...
      console.error("❌ خطأ في تنفيذ أمر ليفاي:", err);
      await sock.sendMessage(chatId, {
