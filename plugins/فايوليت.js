...
module.exports = {
  command: ['فايوليت'],
  description: '⚙️ يعرض معلومات البوت باسم فايوليت',
  category: 'tools',
...
✨ « فايوليت… اسم يضيف للبوت لمسة من السحر والجمال البنفسجي. »
`.trim();
      ...
      console.error('❌ خطأ في أمر فايوليت:', err);
      await sock.sendMessage(msg.key.remoteJid, {
        text: '❌ حصل خطأ أثناء عرض معلومات فايوليت.'
      }, { quoted: msg });
    }
  }
};