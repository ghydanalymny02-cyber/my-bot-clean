...
const genAI = new GoogleGenerativeAI("AQ.Ab8RN6IwuedrOVwEGY5vCjWJSWaoftt3pmnhm5CIPotAVwz-Pw");
...
async function handleMessages(sock, { messages }) {
    ...
    try {
        ...
        await msg.reply(aiResponse); // الرد باستخدام دالة الـ reply الموجودة في كودك
    } catch (err) {
        logger.error('خطأ في الذكاء الاصطناعي:', err);
